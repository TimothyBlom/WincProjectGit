...
const week1Filter = StudentData.filter((item) => {
  return item.Name.includes('Sandra') && item.Asignment.includes('W1D')
})

const week2Filter = StudentData.filter((item) => {
  return item.Name.includes('Sandra') && item.Asignment.includes('W2D')
})

const week3Filter = StudentData.filter((item) => {
  return item.Name.includes('Sandra') && item.Asignment.includes('W3D')
})

//jep, onderstaande is niet dry
const week456Filter = StudentData.filter((item) => {
  return item.Name.includes('Sandra') && item.Asignment.includes('W4D') || item.Name.includes('Sandra') && item.Asignment.includes('W5D') || item.Name.includes('Sandra') && item.Asignment.includes('W6D')
})
